...
\title{基于整数规划与概率分布的最优核酸混检方案}%TODO
\tihao{A}
\baominghao{4321}%TODO check
\schoolname{复旦大学}
\membera{孙夏炀 }
\memberb{任逸昂}
\memberc{陆天一}
...
以下为模型一的结果，？线为我们之前得到的结果，？线为我们将$\rho_k(t)$改为$\rho^*_k(t)$的结果。% TODO: edit ?, delete me after completion
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{q3.png}% TODO: replace your plot here, delete me after completion
